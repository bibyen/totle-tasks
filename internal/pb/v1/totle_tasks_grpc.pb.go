...
func (UnimplementedGoalServiceServer) ListAvailableGoals(context.Context, *ListAvailableGoalsRequest) (*ListAvailableGoalsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListAvailableGoals not implemented")
}
func (UnimplementedGoalServiceServer) BatchGetGoals(context.Context, *BatchGetGoalsRequest) (*BatchGetGoalsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchGetGoals not implemented")
}
...
func (UnimplementedBingoServiceServer) GetBingoCard(context.Context, *GetBingoCardRequest) (*BingoCard, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBingoCard not implemented")
}
func (UnimplementedBingoServiceServer) UpdateBingoCard(context.Context, *UpdateBingoCardRequest) (*BingoCard, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateBingoCard not implemented")
}
...
func RegisterBingoServiceServer(s grpc.ServiceRegistrar, srv BingoServiceServer) {
	// If the following call panics, it indicates UnimplementedBingoServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
